$("#footballDiv").click(function () {
  ...
  $('.close').click(function () {
    $('.modalDialog1').css('opacity', '0').css('pointer-events', 'none');
  ...
  $('.close').click(function () {
    $('.modalDialog2').css('opacity', '0').css('pointer-events', 'none');
  ...
  $('.close').click(function () {
    $('.modalDialog3').css('opacity', '0').css('pointer-events', 'none');
  ...
  $('.close').click(function () {
    $('.modalDialog4').css('opacity', '0').css('pointer-events', 'none');
  ...
  $('.close').click(function () {
    $('.modalDialog7').css('opacity', '0').css('pointer-events', 'none');
